...
/**
 * CLS 响应安全取值工具（自 main 模块 ParseDataUtil/ClsDayTaskHelp 移植，产出契约 DTO）。
 */
@Slf4j
public final class ClsValueUtil {

    private ClsValueUtil() {}
    ...
    /** Map<?,?> → Map<String,Object>：解决 RestClient 反序列化结果的类型擦除 */
    @SuppressWarnings("unchecked")
