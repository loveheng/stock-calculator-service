...
ENTRYPOINT ["/application/stock-calculator", \
            "-Dspring.ai.gemini.api-key=${GEMINI_API_KEY:-dummy-gemini-key}", \
            "-Dspring.ai.openai.api-key=${DEEPSEEK_API_KEY:-dummy-deepseek-key}"]